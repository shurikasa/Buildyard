...
")
  ...
  file(APPEND ${_fpIn} "\n"
    ...
    "  endif()\n"
    "  # Overwriting QT_USE_FILE to include Qt4 directories with the SYSTEM option\n"
    "  include(ConfigureUseQt4)\n"
    "  configure_use_qt4(\${CMAKE_BINARY_DIR}/UseQt4.cmake)\n"
    "  if(EXISTS \${CMAKE_BINARY_DIR}/UseQt4.cmake)\n"
    "    set(QT_USE_FILE \${CMAKE_BINARY_DIR}/UseQt4.cmake)\n"
    "  endif()\n"
    "  include(\${QT_USE_FILE})\n"
    "endif()\n"
