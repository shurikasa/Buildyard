...
function(USE_EXTERNAL_AUTOCONF name)
  ...
  set(CFLAGS "$ENV{CFLAGS} -I${CMAKE_CURRENT_BINARY_DIR}/install/include")
  set(CXXFLAGS "$ENV{CXXFLAGS} -I${CMAKE_CURRENT_BINARY_DIR}/install/include")
  set(LDFLAGS "$ENV{LDFLAGS} -L${CMAKE_CURRENT_BINARY_DIR}/install/lib")
  if(APPLE)
